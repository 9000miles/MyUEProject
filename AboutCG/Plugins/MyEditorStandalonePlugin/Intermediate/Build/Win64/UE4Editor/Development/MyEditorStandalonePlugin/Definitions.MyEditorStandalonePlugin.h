#undef MYEDITORSTANDALONEPLUGIN_API
...
#define ORIGINAL_FILE_NAME "UE4Editor-MyEditorStandalonePlugin.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME AboutCG
...
#define MYEDITORSTANDALONEPLUGIN_API DLLEXPORT
